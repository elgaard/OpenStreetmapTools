...
<xsl:stylesheet
  ...
  <xsl:template match="row">
    <xsl:if test="@pixibranche='Restauranter, pizzeriaer, kantiner m.m.' or @brancheKode='56.10.00.A' or @brancheKode='56.10.00.B'">
